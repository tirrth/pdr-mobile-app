    ...
    return (
      <ScrollView style={{backgroundColor: 'white'}}>
        <FormHeader
          ...
          navigation={() => push('AddNewAddress', {redirect_to_cart: false})}
        />
          ...
          <View
            ...
            <TextInput
              ...
              onChangeText={(confirm_pass) =>
                this._onConfirmPasswordClick(confirm_pass)
              }
              onEndEditing={(e) =>
                this._confirmPasswordValidation(e.nativeEvent.text)
              }
            ...
            <View
              ...
              <IconButton
                ...
                icon={!this.state.showConfirmPassword ? 'eye' : 'eye-off'}
                size={18}
                color="#8d8d8d"
              />
            </View>
