    ...
    _onSubmit = (props) => {
        if(this.props.phone !== ""){
          ...
          .then(function(response) {
            ...
            props.push("OTPVerification", { only_mobile_otp: true, phone_otp: response.data.phone_otp });
          })
        ...
        return (
            <ScrollView style={{backgroundColor: 'white'}}>
                ...
                <View style={styles.textinputcontainermain}>
                    ...
                    <View>
                        <Ripple style={{marginTop:0, rippleContainerBorderRadius:4}} onPress={() => this._onSubmit(this.props.navigation)}>
